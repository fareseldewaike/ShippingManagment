...
namespace Shipping.repo.Migrations
{
    ...
    public partial class v0 : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Orders_Rejections_RejectionId",
            ...
            migrationBuilder.CreateTable(
                name: "RepresentativeGovernorates",
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_RepresentativeGovernorates", x => x.Id);
                    table.ForeignKey(
                        name: "FK_RepresentativeGovernorates_AspNetUsers_RepresentativeId",
                        column: x => x.RepresentativeId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_RepresentativeGovernorates_Governorates_GovernorateId",
                        column: x => x.GovernorateId,
                        principalTable: "Governorates",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RepresentativeGovernorates_GovernorateId",
                table: "RepresentativeGovernorates",
                column: "GovernorateId");

            migrationBuilder.CreateIndex(
                name: "IX_RepresentativeGovernorates_RepresentativeId",
                table: "RepresentativeGovernorates",
                column: "RepresentativeId");
